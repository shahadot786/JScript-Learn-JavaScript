...
public final class CustomToastLayoutBinding implements ViewBinding {
  ...
  private CustomToastLayoutBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout toastLayout, @NonNull TextView toastText) {
  ...
  public static CustomToastLayoutBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      ConstraintLayout toastLayout = (ConstraintLayout) rootView;
      ...
      return new CustomToastLayoutBinding((ConstraintLayout) rootView, toastLayout, toastText);
    }
