...
public final class FragmentHomeBinding implements ViewBinding {
  ...
  private FragmentHomeBinding(@NonNull ConstraintLayout rootView, @NonNull ViewPager homeViewPager,
      @NonNull TabLayout tabLayoutHome, @NonNull Toolbar toolbar) {
  ...
  public static FragmentHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHomeBinding((ConstraintLayout) rootView, homeViewPager, tabLayoutHome,
          toolbar);
    }
