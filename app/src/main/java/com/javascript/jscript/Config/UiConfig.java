...
public class UiConfig {
    ...
    public static final boolean INTERSTITIAL__AD_VISIBILITY = false;//if true then show interstitial ad
    public static final int INTERSTITIAL_AD_INTERVAL = 4;//how many times showed ads
    //pro
